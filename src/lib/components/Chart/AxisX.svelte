<!--
 ...
 <script>
  ...
  /** @type {Number} [titleGutter=0] - The amount of whitespace between the axis title and the chart drawing area (the yRange min). */
...
<g class="axis x-axis" class:snapLabels>
  ...
  {/each}
  {#if title !== ''}
    <g class="axis-title" transform="translate({$width/2},{Math.max(...$yRange) + titleGutter})">
      <text
        x={halfBand}
